...
------------------------------------------ */
const URLS = [
  "http://103.30.72.94:8011/import/portReport/topHSCode",
  "http://103.30.72.94:8011/import/portReport/topOriginCountryDestinationCountry",
  "http://103.30.72.94:8011/import/portReport/topBuyerSupplier",
  "http://103.30.72.94:8011/import/portReport/uniqueBuyerSupplier",
  "http://103.30.72.94:8011/export/portReport/topHSCode",
  "http://103.30.72.94:8011/export/portReport/topOriginCountryDestinationCountry",
  "http://103.30.72.94:8011/export/portReport/topBuyerSupplier",
  "http://103.30.72.94:8011/export/portReport/uniqueBuyerSupplier",
  "http://103.30.72.94:8011/portReport/forTotal",
];
...
/* -----------------------------------------
   Customs countries
------------------------------------------ */
const CUSTOMS_COUNTRIES = new Set([
  "argentina","bangladesh","bolivia","botswana","burundi","cameroon","chile",
  "colombia","costa_rica","cote_d_ivoire","dr_congo","ecuador","ethiopia",
  "fiji","ghana","guatemala","guyana","india","indonesia","kazakhstan",
  "kenya","kosovo","lesotho","liberia","malawi","mexico","moldova",
  "nicaragua","nigeria","pakistan","panama","paraguay","peru","philippines",
  "russia","rwanda","sao_tome_and_principe","sierra_leone","singapore",
  "sri_lanka","tanzania","turkey","uganda","ukraine","uruguay","uzbekistan",
