  ...
  const oneCountryPlans = [
    {
      ...
      features: [
        ...
        "Choose Any One country except(Turkey, Vietnam, Russia, Bangladesh, USA, Ghana, Zambia, Kenya, Kazakhstan, Peru, Indonesia, and Mexico)",
        "3 Month Validity",
      ],
          ...
          {plans.map((plan) => (
            <div key={plan.name} className="rounded-2xl shadow-lg overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 -bottom-18 z-10">
