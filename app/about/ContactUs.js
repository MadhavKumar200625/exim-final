        ...
        <form className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex">
              ...
              <input
                type="tel"
                className="flex-1 border border-gray-300 rounded-r-lg px-4 py-2"
                value={mobile}
          ...
          <div>
            ...
            <button
              ...
              className="w-full border border-gray-300 rounded-md px-4 py-2 flex justify-between"
            >
          ...
          <div className="md:col-span-3 flex justify-center mt-4">
            <button
              ...
              disabled={loading}
              onClick={aboutEmail}
              className="px-6 py-3 bg-blue-600 text-white hover:scale-105 transition"
            >
