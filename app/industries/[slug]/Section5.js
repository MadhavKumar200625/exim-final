      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          {industries.map((industry, idx) => (
            ...
            >
              {/* Image */}
              <div className="relative w-full sm:w-40 md:w-48 lg:w-60 aspect-4/3 border border-gray-200 bg-gray-50 shrink-0">
                <img
                  src={`/solutions/${industry.title
                    .toLowerCase()
                    .replace(/ /g, "-")
                    .replace("&", "and")}.webp`}
                  alt={`${industry.title} industry trade data`}
